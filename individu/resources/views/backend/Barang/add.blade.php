...
<body>
  ...
  <div class="sidebar">
    ...
    <a href="" class="menu-item active"><i class="fas fa-home"></i> Home</a>
    ...
    <div class="row">
          <div class="col-md-12">
            <div class="card card-info">
              ...
              <form class="form-horizontal" method="POST" action="{{ url('barang/add') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                  <div class="card-body">
                      <div class="form-group row">  
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="kodebarang" class="form-control" placeholder="Masukan Nama Barang" required>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" name="hargasatuan" class="form-control" placeholder="Masukan Harga Satuan" required>
